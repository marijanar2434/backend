...
class UploadVehicleDocumentationHandler implements CommandHandler
{
    /**
     ...
     * @inheritDoc
     */
    public function __invoke(UploadVehicleDocumentationCommand  $command)
    {
        $path = sprintf(
            '/vehicles/vehicles/documentation/%s/%s.%s',
            Uuid::uuid6()->toString(),
