...
class CollaboratorNotFoundException extends ApplicationServiceException
{
    /**
     ...
     */
    public function __construct($message = 'collaborator.not.found', $code = 0, Throwable $previous = null)
    {
