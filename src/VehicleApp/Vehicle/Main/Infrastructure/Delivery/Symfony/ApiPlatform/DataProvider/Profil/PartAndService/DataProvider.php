...
namespace App\VehicleApp\Vehicle\Main\Infrastructure\Delivery\Symfony\ApiPlatform\DataProvider\Profil\PartAndService;
...
use App\VehicleApp\Vehicle\Main\Application\Query\Profil\PartAndService\PartAndServiceCollectionQuery;
...
class DataProvider implements ContextAwareCollectionDataProviderInterface, RestrictedDataProviderInterface, ItemDataProviderInterface
{
    ...
    public function supports(string $resourceClass, ?string $operationName = null, array $context = []): bool
    {
        ...
        return (PartAndService::class === $resourceClass  && ($context['operation_type'] ?? null) !== 'subresource') ||
            (PartAndService::class === $resourceClass && ($context['operation_type'] ?? null) === 'subresource');
    }
    ...
    public function getCollection(string $resourceClass, ?string $operationName = null, array $context = []): iterable
    {
        ...
        $query = new PartAndServiceCollectionQuery(
        ...
        return new Paginator(
            Arr::map($queryResult->getResult(), fn ($dto) => $this->fromPartAndServiceDto($dto)),
            (int)Arr::get($context, 'filters.page', 1),
            (int)Arr::get($context, 'filters.size', 10),
     ...
     * @inheritDoc
     */
    public function getItem(string $resourceClass, $id, string $operationName = null, array $context = []): ?PartAndService
    {
        $query = new PartAndServiceCollectionQuery(
            1,
            1,
        ...
        return $this->fromPartAndServiceDto($queryResult->getFirst());
    }

    /**
     * @param PartAndServiceDto $dto
     *
     * @return PartAndService
     */
    private function fromPartAndServiceDto(PartAndServiceDto $dto): PartAndService
    {

        $partAndService = new PartAndService();
        $partAndService->id = $dto->getId();
        $partAndService->name = $dto->getName();
