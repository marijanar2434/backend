...
namespace App\VehicleApp\Vehicle\Main\Infrastructure\Delivery\Symfony\ApiPlatform\Model\Profil\Damage;
...
class Damage
{
    ...
    #[Assert\NotBlank(groups: ['create', 'update'])]
    #[Assert\Type('float', groups: ['create', 'update'])]
    #[Groups(['read', 'create', 'update'])]
    public float $fee;
