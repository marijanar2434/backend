...
namespace App\VehicleApp\Vehicle\Main\Infrastructure\Delivery\Symfony\ApiPlatform\DataProvider\Profil\DamageCoverage;
...
use App\VehicleApp\Vehicle\Main\Application\Query\Profil\DamageCoverage\DamageCoverageCollectionQuery;
...
class DataProvider implements ContextAwareCollectionDataProviderInterface, RestrictedDataProviderInterface, ItemDataProviderInterface
{
    ...
    public function supports(string $resourceClass, ?string $operationName = null, array $context = []): bool
    {
        ...
        return (DamageCoverage::class === $resourceClass  && ($context['operation_type'] ?? null) !== 'subresource') ||
            (DamageCoverage::class === $resourceClass && ($context['operation_type'] ?? null) === 'subresource');
    }
    ...
    public function getCollection(string $resourceClass, ?string $operationName = null, array $context = []): iterable
    {
        ...
        $query = new DamageCoverageCollectionQuery(
        ...
        return new Paginator(
            Arr::map($queryResult->getResult(), fn ($dto) => $this->fromDamageCoverageDto($dto)),
            (int)Arr::get($context, 'filters.page', 1),
            (int)Arr::get($context, 'filters.size', 10),
     ...
     * @inheritDoc
     */
    public function getItem(string $resourceClass, $id, string $operationName = null, array $context = []): ?DamageCoverage
    {
        $query = new DamageCoverageCollectionQuery(
            1,
            1,
        ...
        return $this->fromDamageCoverageDto($queryResult->getFirst());
    }

    /**
     * @param DamageCoverageDto $dto
     *
     * @return DamageCoverage
     */
    private function fromDamageCoverageDto(DamageCoverageDto $dto): DamageCoverage
    {

        $damageCoverage = new DamageCoverage();
        $damageCoverage->id = $dto->getId();
        $damageCoverage->name = $dto->getName();
