...
class DetachRoleFromUserHandler implements CommandHandler
{
    /**
     * @var UserRepository
     */
    ...
    /**
     * DetachRoleFromUserHandler Constructor
     *
     ...
     * @inheritDoc
     */
    public function __invoke(DetachRoleFromUserCommand $command)
    {
        /**
         * @var User|null
         */
